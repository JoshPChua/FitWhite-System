-- ============================================================
-- FitWhite Aesthetics POS - Seed Data (IMUS-ONLY)
-- For Imus pilot production. Seeds ONLY the Imus branch.
-- For multi-branch setup, use seed-multibranch.sql instead.
